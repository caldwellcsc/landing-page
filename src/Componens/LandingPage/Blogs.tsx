...
export const Blogs: Component = () => {
  return (
    <section class="bg-white py-48" id="blogs">
      <div class="container px-6 py-10 mx-auto">
        <div class="text-center">
          <h1 class="text-3xl font-bold leading-none tracking-tighter text-neutral-600 capitalize lg:text-4xl ">
            {/* max-w-5xl text-2xl font-bold leading-none tracking-tighter text-neutral-600 md:text-5xl lg:text-7xl lg:max-w-7xl */}
            From the blog
          </h1>

          <p class="max-w-lg mx-auto mt-4 text-base leading-relaxed text-center text-gray-500">
            {/* text-base leading-relaxed text-center text-gray-500 */}
            What is Caldwell CSC up to? Find out from our latest blogs.
          </p>
        </div>
